...
<?php get_header();?>
 ...
 <div class="page-banner">
      ...
      <div class="page-banner__content container t-center c-white">
        ...
        <h2 class="headline headline--medium">to Eduslack, We think you&rsquo;ll like it here</h2>
        <h3 class="headline headline--small">Why don&rsquo;t you check out the <strong>Subject</strong> you&rsquo;re interested in?</h3>
        <a href="#" class="btn btn--large btn--blue">Find Resources</a>
      </div>
    </div>
